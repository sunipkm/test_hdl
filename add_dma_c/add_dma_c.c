...
int main()
{
    ...
    unsigned short *virtual_source_address = mmap(NULL, 65535, PROT_READ | PROT_WRITE, MAP_SHARED, dh, 0x0e000000); // Memory map source address
    int *virtual_destination_address = mmap(NULL, 65535, PROT_READ | PROT_WRITE, MAP_SHARED, dh, 0x0f000000);       // Memory map destination address

    virtual_source_address[0] = 0xdead; // Set up memory for addition
    virtual_source_address[1] = 0xbeef;

    virtual_source_address[2] = 0xbaad;
    virtual_source_address[3] = 0xdaad;

    virtual_source_address[4] = 0x0;
    virtual_source_address[5] = 0xdead;

    virtual_source_address[6] = 0x0101;
    virtual_source_address[7] = 0x0220;
